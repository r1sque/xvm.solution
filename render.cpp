...
void render::init( ) {
	menu		= Font( XOR( "Montserrat" ), 17, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	menu_shade	= Font( XOR( "Montserrat" ), 18, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	esp_small2	= Font( XOR( "Small Fonts" ), 11, FW_MEDIUM, FONTFLAG_ANTIALIAS);
	esp_name	= Font( XOR( "Verdana" ), 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
	esp_other	= Font( XOR( "Verdana" ), 12, FW_BOLD, FONTFLAG_DROPSHADOW);
	hud			= Font( XOR( "Montserrat" ), 17, FW_SEMIBOLD, FONTFLAG_ANTIALIAS );
	...
	manualaa2	= Font( XOR( "Montserrat" ), 18, FW_SEMIBOLD, FONTFLAG_ANTIALIAS);
	output		= Font( XOR( "Verdana" ), 12, FW_BOLD, FONTFLAG_OUTLINE);
	logevent	= Font( XOR( "Verdana" ), 14, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_DROPSHADOW | FONTFLAG_DROPSHADOW);
